  ...
  create or replace view `laplap-analytics`.`laplap_analytics`.`stg_laptop_benchmark_result`
  OPTIONS()
  as 
...
FROM `laplap-analytics`.`laplap_analytics`.`bronze_laptop_benchmark_result`;
